...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1"},{"charset":"utf-16"},{"name":"description","content":"Next Gen Technologie."}],"link":[],"style":[],"script":[],"noscript":[],"charset":"utf-16","viewport":"width=device-width, initial-scale=1, maximum-scale=1","title":"Next Gen Technologies"};
